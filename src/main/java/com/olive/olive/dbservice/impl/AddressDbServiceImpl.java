...
import com.olive.olive.dbservice.mapper.AddressEMM;
import com.olive.olive.dbservice.repository.AddressRepository;
...
public class AddressDbServiceImpl implements AddressDbService {
  ...
  @Override
  public Map<Integer, Address> findAddressWithinLatitudeAndLongitudeRange(
